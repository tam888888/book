...
screen.append(boxChange);
topright.append(boxChange1);
boxChange.on('click', function (data) {

  // console.log(boxChange.width == 1/2 *screen.height,boxChange.width,1/2 *screen.height,process.stdout.columns,process.stdout.rows)
  if(boxChange.width <= 1/2 *process.stdout.columns){
    boxChange.width = '100%'
    boxChange.height = '100%'
  }else{
    boxChange.width = '25%'
    boxChange.height = '50%'
  }
